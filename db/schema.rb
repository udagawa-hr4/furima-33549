...
ActiveRecord::Schema.define(version: 2021_01_21_014817) do
  ...
  create_table "shopping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_id"], name: "index_shopping_addresses_on_purchase_id"
  end
  ...
  add_foreign_key "shopping_addresses", "purchases"
end
